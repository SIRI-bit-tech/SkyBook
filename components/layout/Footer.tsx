        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-white/80 text-sm leading-relaxed">
              Your trusted partner for flight bookings worldwide. Book with confidence and fly with ease.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/press" className="text-white/80 hover:text-white transition text-sm">
                  Press
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/help" className="text-white/80 hover:text-white transition text-sm">
                  Help
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/dashboard/bookings" className="text-white/80 hover:text-white transition text-sm">
                  My Bookings
                </Link>
              </li>
            </ul>
